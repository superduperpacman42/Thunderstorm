...
class Game:
    ...
    def key_pressed(self, key):
        ...
        if key == pygame.K_RETURN:
            if self.splash:
                self.splash = False
                play_music("A_Dark_and_Stormy_Night.ogg")
                self.t = 0
    ...
    def __init__(self, name):
        ...
        play_sound("Thunder.ogg", False, 0.05)
        play_sound("Wind.ogg", False, 0.1)
        play_sound("Lamp.ogg", False, 0.1)
        play_sound("Rain.ogg", False, 0.0)
        # set_volume(0.05)
